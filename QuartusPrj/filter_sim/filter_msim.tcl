...
transcript on
write transcript filter_transcript
...
set quartus_rootdir D:/programmer/alterasuite/11.1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists filter.vhd]} {vcom -93 -work work filter.vhd}
    if {[file exists filter.v]} {vlog -work work filter.v}
    vcom -93 -work work filter_ast.vhd
    vcom -93 -work work filter_rtl.vhd

    if { [file exists filter_rtl_wysiwyg.vhd] } {
        vcom -93 -work work filter_rtl_wysiwyg.vhd
    }
